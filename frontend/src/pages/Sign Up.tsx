...
const Signup: React.FC = () => {
  ...
  return (
    <section className="login flex xl:flex-row flex-col justify-between items-center p-5 h-[100vh] overflow-clip xl:p-0">
      <ToastContainer />
      ...
      <div className="social-login flex flex-col items-center w-full">
        ...
        <div className="flex justify-center w-full">
          <button
            type="button"
            className="w-1/2 flex justify-center max-w-96 items-center bg-none bg-white h-10 border-none text-gray-600 font-normal text-[12px]"
      ...
      <img src={signupImage} alt="" className="hidden xl:flex w-1/2 aspect-video h-full justify-self-start overflow-clip "/>
      <span className="absolute  xl:right-10 top-5 right-5 xl:bottom-10 xl:top-auto xl:bg-transparent bg-white rounded-lg"><Logo className="xl:w-28 w-20 "/></span>
    </section>
  );
};
